  ...
  return (
    <div data-testid="app-store-buttons" className="flex items-center gap-3 flex-shrink-0">
      ...
      <button
        ...
        className="h-12 px-4 gap-3 bg-black rounded-xl flex items-center hover:bg-gray-800 transition-colors duration-200 whitespace-nowrap flex-shrink-0"
      >
        <svg viewBox="0 0 24 24" className="w-7 h-7 text-white fill-current flex-shrink-0" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="text-left leading-tight flex-shrink-0">
          ...
          <div className="text-white text-base font-semibold">App Store</div>
        </div>
      </button>
      ...
      >
        ...
        <div className="text-left leading-tight flex-shrink-0">
          ...
          <div className="text-white text-base font-semibold">Google Play</div>
        </div>
      </button>
    </div>
  );
